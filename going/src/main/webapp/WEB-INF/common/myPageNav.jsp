...
<div class="dashboard-sidebar">
    <div class="user-image">
        <img src="./assets/images/MyPage/imgMy.jpg" alt="#" />
        <h3>
            김여행님
    ...
    <div class="dashboard-menu">
        <ul>
            <li><a  href="./myReserve.html"><i class="lni lni-dashboard"></i>
                    예약/결제 관리</a></li>
            <li><a href="profile-settings.html"><i class="lni lni-pencil-alt"></i> 회원정보 관리</a>
            </li>
            <!-- <li><a href="my-items.html"><i class="lni lni-bolt-alt"></i> My Ads</a></li> -->
            <li><a href="myPaymentHistory.html"><i class="lni lni-heart"></i> 리뷰관리</a></li>
            <li><a class="active" href="./travelRegister.html"><i class="lni lni-circle-plus"></i> 상품등록(사업자)</a></li>
