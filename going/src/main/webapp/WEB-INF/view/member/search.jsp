                                                ...
                                                <div class="single-item-grid">
                                                    <div class="row align-items-center">
                                                        <div class="col-lg-5 col-md-7 col-12">
                                                            <div class="image">
                                                                <a href="list_Detail_final.html"><img src="${pageContext.request.contextPath}/resources/images/search/japan.png" alt="#"></a>
                                                        ...
                                                        <div class="col-lg-7 col-md-5 col-12">
                                                            <div class="content">
                                                                ...
                                                                <h3 class="title">
                                                                    <a href="list_Detail_final.html">일본 홋카이도 3박4일</a>
                                                                </h3>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-12">
                                                ...
                                                <div class="single-item-grid">
                                                    <div class="row align-items-center">
                                                        <div class="col-lg-5 col-md-7 col-12">
                                                            <div class="image">
                                                                <a href="list_Detail_final.html"><img src="${pageContext.request.contextPath}/resources/images/search/bangkok.png" alt="#"></a>
                                                                <i class=" cross-badge lni lni-bolt"></i>
                                                                <span class="flat-badge sale">할인</span>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-7 col-md-5 col-12">
                                                            <div class="content">
                                                                <a href="javascript:void(0)" class="tag">해외여행</a>
                                                                <h3 class="title">
                                                                    <a href="list_Detail_final.html">태국 방콕/파티야 3박5일</a>
                                                                </h3>
                                                                <p class="location"><a href="javascript:void(0)"><i
                                                                            class="lni lni-map-marker">
                                                                        </i>방콕-파타야</a></p>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-12">
                                                ...
                                                <div class="single-item-grid">
                                                    <div class="row align-items-center">
                                                        <div class="col-lg-5 col-md-7 col-12">
                                                            <div class="image">
                                                                <a href="list_Detail_final.html"><img src="${pageContext.request.contextPath}/resources/images/search/japan2.png" alt="#"></a>
                                                                <i class=" cross-badge lni lni-bolt"></i>
                                                        ...
                                                        <div class="col-lg-7 col-md-5 col-12">
                                                            <div class="content">
                                                                <a href="javascript:void(0)" class="tag">해외여행</a>
                                                                <h3 class="title">
                                                                    <a href="list_Detail_final.html">일본 규수 3박4일</a>
                                                                </h3>
                                                                <p class="location"><a href="javascript:void(0)"><i
                                                                            class="lni lni-map-marker">
                                                                        </i>규수</a></p>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-12">
                                                ...
                                                <div class="single-item-grid">
                                                    <div class="row align-items-center">
                                                        <div class="col-lg-5 col-md-7 col-12">
                                                            <div class="image">
                                                                <a href="list_Detail_final.html"><img src="${pageContext.request.contextPath}/resources/images/search/euro.png" alt="#"></a>
                                                                <i class=" cross-badge lni lni-bolt"></i>
                                                                <span class="flat-badge sale">할인</span>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-7 col-md-5 col-12">
                                                            <div class="content">
                                                                <a href="javascript:void(0)" class="tag">해외여행</a>
                                                                <h3 class="title">
                                                                    <a href="list_Detail_final.html">동유럽3국 9박10일</a>
                                                                </h3>
                                                                <p class="location"><a href="javascript:void(0)"><i
                                                                            class="lni lni-map-marker">
                                                                        </i>체코,오스트리아,헝가리</a></p>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-12">
                                                ...
                                                <div class="single-item-grid">
                                                    <div class="row align-items-center">
                                                        <div class="col-lg-5 col-md-7 col-12">
                                                            <div class="image">
                                                                <a href="list_Detail_final.html"><img src="${pageContext.request.contextPath}/resources/images/search/sydeni.png" alt="#"></a>
                                                                <i class=" cross-badge lni lni-bolt"></i>
                                                                <span class="flat-badge rent">인기</span>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-7 col-md-5 col-12">
                                                            <div class="content">
                                                                <a href="javascript:void(0)" class="tag">해외여행</a>
                                                                <h3 class="title">
                                                                    <a href="list_Detail_final.html">시드니 4박6일</a>
                                                                </h3>
