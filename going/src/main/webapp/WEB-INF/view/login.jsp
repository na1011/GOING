...
.items-grid .single-grid .image .author::before {
   height: 0; . board { margin-top : 20px;
   height: 100px;
   left: 0px;
   bottom: 15px;
   position: relative;
...
.KAKAO {
   background-image: url(${pageContext.request.contextPath}/webapp/resources/images/login/kakao_login_large_wide.png);
                            ...
                            <nav>
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    <button class="nav-link active show1"
                                        ...
                                        aria-selected="true">고객 가입</button>
                                    <button class="nav-link show2" id="nav-list-tab" data-bs-toggle="tab"
                                        ...
                                        aria-selected="false">사업자 가입</button>
                                </div>
                            </nav>
                        </div>
                        <div>
                            <div class="d1">
                                <form action="#!" method="post"
                                    ...
                                    <div class="socila-login">
                                        <ul>
                                            <li><a href="javascript:void(0)" class="KAKAO" img>
                                            <i class="lni lni-kakao">카카오로 시작하기</i></a></li>
                                        </ul>
                                    </div>
                                    <p class="outer-link">
